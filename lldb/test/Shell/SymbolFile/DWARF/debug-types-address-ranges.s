...
# CHECK:      Function: id = {0x1fffffff0000006a}, name = "::_start({{.*}})", range = [0x0000000000048000-0x000000000004800c)
...
# CHECK:      Variable: id = {0x1fffffff00000075}, name = "v1", {{.*}} decl = a.cc:4
# CHECK:      Variable: id = {0x1fffffff00000080}, name = "v2", {{.*}} decl = a.cc:4
