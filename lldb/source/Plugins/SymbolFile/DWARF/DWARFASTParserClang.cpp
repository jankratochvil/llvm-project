...
bool DWARFASTParserClang::CompleteTypeFromDWARF(MainDWARFCompileUnit *main_unit, const DWARFDIE &die,
  ...
  case DW_TAG_union_type:
  case DW_TAG_class_type:
    return CompleteRecordType(main_unit, die, type, clang_type);
  case DW_TAG_enumeration_type:
...
Function *DWARFASTParserClang::ParseFunctionFromDWARF(CompileUnit &comp_unit,
  ...
  if (die.GetDIENamesAndRanges(name, mangled, func_ranges, decl_file, decl_line,
    ...
    if (func_range.GetBaseAddress().IsValid()) {
      MainDWARFCompileUnit *main_unit = comp_unit.GetMainDWARFCompileUnit();
...
void DWARFASTParserClang::ParseSingleMember(lldb_private::CompileUnit *comp_unit, const DWARFDIE &die, const DWARFDIE &parent_die,
  ...
  MainDWARFCompileUnit *main_unit = !comp_unit ? nullptr : comp_unit->GetMainDWARFCompileUnit();
